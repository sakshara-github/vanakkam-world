pipeline {
    ...
    environment {
        ...
        EC2_USER = 'ubuntu'
        EC2_HOST = 'ec2-204-236-159-254.us-west-1.compute.amazonaws.com'
    ...
    stages {
        ...
        stage('Authenticate to AWS ECR') {
            steps {
                ...
                docker login --username ubuntu --password-stdin ${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com
                """
            }
        }
